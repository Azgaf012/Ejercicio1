<%-- 
    Document   : index
    Created on : 24-feb-2019, 15:03:36
    Author     : Karin
--%>
                    ...
                    <div class="row" style="padding: 20px;">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h6>CATEGORIAS</h6>
                                    <form id="FrmCategori" action="action">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="btnBuscarCategoria" class="btn btn-primary btn-xs mr-3"><i class="fa fa-search" aria-hidden="true"> BUSCAR</i></button>
                                                <button type="button  " id="btnAbrirNuevaCategoria" class="btn btn-primary btn-xs"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
